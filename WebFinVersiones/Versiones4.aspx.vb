...
Public Class Versiones4
    ...
    Private Sub HypExportExcel_Click(sender As Object, e As EventArgs) Handles HypExportExcel.Click
        Try
    ...
    Private Sub HypExportWord_Click(sender As Object, e As EventArgs) Handles HypExportWord.Click
        Try
